...
parser.add_argument('--titlesL1L2', action="store", dest="titlesL1L2", help='A file with titleL1 titleL2 (only titlesL2 will be converted.',required=True)
...
validtitles=[]
entrada=codecs.open(titlesL1L2,"r",encoding="utf-8")
for linia in entrada:
    linia=linia.rstrip()
    try:
        (L1,L2)=linia.split("\t")
        validtitles.append(L2)
    except:
        pass
